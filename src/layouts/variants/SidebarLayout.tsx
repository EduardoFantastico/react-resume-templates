...
export default function SidebarLayout() {
  ...
  return (
    <BaseLayout variant="sidebar" fullBleed>
      <div className="xl:flex xl:min-h-[calc(100vh-5rem)]">
        <aside className="space-y-8 bg-primary p-8 text-white sm:p-10 xl:fixed xl:bottom-0 xl:left-0 xl:top-20 xl:w-[30%] xl:overflow-y-auto xl:p-10">
        ...
        <main className="space-y-14 px-6 py-12 sm:px-10 sm:py-16 xl:ml-[30%] xl:w-[70%] xl:px-14 xl:py-20">
